...
class PEViewController: UIViewController {
    ...
    func adjustTextSizeForLabel( label: UILabel){
        ...
        let attributedText = NSAttributedString(string: labelString, attributes: [NSForegroundColorAttributeName: UIColor.black, NSFontAttributeName: font, NSParagraphStyleAttributeName:paragraphStyle])
